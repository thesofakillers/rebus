...
- "ran" -> also works in different tenses -> <answer>yes</answer>
- "sleeping" -> figure lying with 'Z's -> <answer>yes</answer>
- "entering" -> this typically requires a second object (a door) -> <answer>no</answer>
...
Heuristic 7: If MULTIPLE SUBJECTS need to be drawn to represent the word, it is not "drawable".
...
Note 4: If the drawing would depend on drawing arrows or other point-to-point indicators, it is not a "drawable" word.
Note 5: If the word requires writing or text to be drawn, it is not a "drawable" word.
